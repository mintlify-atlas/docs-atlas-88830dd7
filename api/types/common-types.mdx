---
title: 'Common Types'
description: 'Common TypeScript types used across React Native ExecuTorch'
---
...
<ResponseField name="dataPtr" type="TensorBuffer" required>
  The data buffer of the tensor.
</ResponseField>

<ResponseField name="sizes" type="number[]" required>
  An array representing the size of each dimension of the tensor.
</ResponseField>

<ResponseField name="scalarType" type="ScalarType" required>
...
<ResponseField name="scalarType" type="ScalarType.BYTE" required>
...
<ResponseField name="getNativeBuffer" type="() => { pointer: bigint; release(): void }" required>
